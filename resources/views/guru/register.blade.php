...
<head>
    ...
    <title>Registrasi Guru - Madingaja</title>
            ...
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('guru.register.post') }}">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nip" placeholder="Masukkan NIP..." value="{{ old('nip') }}" required>
                            </div>
                            <div class="form-group mb-3">
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('guru.login') }}" class="btn btn-outline-primary btn-sm">
