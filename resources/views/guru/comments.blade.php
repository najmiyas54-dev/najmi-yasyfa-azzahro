...
<head>
    ...
    <title>Komentar - Guru Panel</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 px-0 sidebar">
                <div class="p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="{{ route('guru.comments') }}">
            ...
            <div class="col-md-9 col-lg-10">
                <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4">
                    <div class="container-fluid">
                        <h4 class="mb-0 fw-bold text-dark">Komentar pada Artikel Saya</h4>
                        <span class="badge bg-info fs-6">{{ $comments->total() }} komentar</span>
                    </div>
                </nav>
                    ...
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div>
                                                ...
                                                <small class="text-muted">
                                                    ...
                                                    <a href="{{ route('single', $comment->post->id) }}" target="_blank" class="text-decoration-none">
                                                        {{ strlen($comment->post->title) > 50 ? substr($comment->post->title, 0, 50) . '...' : $comment->post->title }}
                                                    </a>
                                                </small>
                                            </div>
                                        </div>
                            ...
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Komentar pada artikel Anda akan muncul di sini</p>
                            </div>
                            @endforelse
