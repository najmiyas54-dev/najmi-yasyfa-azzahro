...
@section('content')
<!-- Kegiatan Header -->
<section class="py-5" style="background: linear-gradient(135deg, #c3ceff 0%, #e2c8fc 100%); margin-top: 70px;">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center text-white">
                <div class="mb-4">
                    <i class="fa fa-calendar-alt fa-3x mb-3" style="opacity: 0.8;"></i>
                </div>
                <h1 class="mb-3" style="font-family: 'Baloo 2', cursive; font-weight: 700; font-size: 2.5rem;">Kegiatan Sekolah</h1>
                <p class="mb-4 lead">Dokumentasi aktivitas dan kegiatan menarik di SMK Bakti Nusantara 666</p>
                <div class="d-flex justify-content-center flex-wrap">
                    <span class="badge badge-light badge-pill px-3 py-2 mr-3 mb-2" style="font-size: 0.9rem;">
                        <i class="fa fa-calendar mr-1"></i> {{ \App\Models\Post::where('category', 'kegiatan')->where('approval_status', 'published')->count() }} Kegiatan
                    </span>
                    <span class="badge badge-light badge-pill px-3 py-2 mb-2" style="font-size: 0.9rem;">
                        <i class="fa fa-eye mr-1"></i> {{ number_format(\App\Models\Post::where('category', 'kegiatan')->sum('views_count')) }} Views
                    </span>
                </div>
            </div>
        </div>
...
<!-- Kegiatan Section -->
<section class="kegiatan-page py-5" style="background: #f8f9fa;">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h2 class="mb-1" style="color: #2c3e50; font-weight: 600;">Kegiatan Terbaru</h2>
                        <p class="text-muted mb-0">Temukan berbagai aktivitas menarik di sekolah kami</p>
                    </div>
                </div>
                        ...
                        @if($post->image_path && $post->image_path != '')
                            <div class="position-relative" style="overflow: hidden;">
                                ...
                                <div class="position-absolute" style="top: 15px; left: 15px;">
                                    <span class="badge badge-primary px-3 py-2" style="font-size: 0.8rem; border-radius: 20px;">
                                        <i class="fa fa-calendar mr-1"></i> Kegiatan
                                    </span>
                                </div>
                            </div>
                        @endif
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="d-flex align-items-center text-muted small">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <i class="fa fa-heart mr-1" style="color: #e73c9a;"></i> {{ number_format($post->likes_count ?? 0) }}
                                    </div>
                                </div>
                            </div>
                ...
                @else
                    <div class="text-center py-5">
                        <div class="mb-4">
                            <i class="fa fa-calendar-times fa-5x text-muted" style="opacity: 0.3;"></i>
                        </div>
                        <h4 class="text-muted mb-3">Belum Ada Kegiatan</h4>
                        <p class="text-muted mb-4">Kegiatan sekolah yang menarik akan segera hadir. Pantau terus halaman ini untuk update terbaru!</p>
                        <a href="{{ route('home') }}" class="btn btn-primary px-4" style="border-radius: 20px;">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sticky-top" style="top: 100px;">
                    ...
                    <div class="card mb-4 shadow-sm" style="border: none; border-radius: 15px; overflow: hidden;">
                        <div class="card-header text-white" style="background: linear-gradient(135deg, #c3ceff 0%, #e2c8fc 100%); border: none;">
                            <h5 class="mb-0 d-flex align-items-center">
                                <i class="fa fa-info-circle mr-2"></i> Tentang Kegiatan
                            </h5>
                        </div>
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted mb-0" style="font-size: 0.9rem; line-height: 1.5;">Media dokumentasi kegiatan dan aktivitas sekolah yang menampilkan berbagai program unggulan SMK Bakti Nusantara 666.</p>
                        </div>
                    </div>
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-6 mb-3">
                                    <div class="p-3 rounded" style="background: rgba(220, 53, 69, 0.1);">
                                        <h4 class="text-danger mb-1">{{ \App\Models\Post::where('category', 'pengumuman')->where('approval_status', 'published')->count() }}</h4>
                        ...
                        <div class="card-body p-0">
                            <div class="list-group list-group-flush">
                                ...
                                <a href="{{ route('blog') }}" class="list-group-item list-group-item-action border-0 py-3" style="transition: all 0.3s ease;">
                                    <i class="fa fa-newspaper mr-3 text-info"></i> Blog & Berita
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="text-muted d-flex align-items-center">
                                ...
                                <span>Menampilkan {{ $kegiatan->firstItem() }} - {{ $kegiatan->lastItem() }} dari {{ $kegiatan->total() }} kegiatan</span>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            <nav aria-label="Kegiatan pagination">
                                <ul class="pagination pagination-lg mb-0" style="border-radius: 10px; overflow: hidden;">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $kegiatan->previousPageUrl() }}" rel="prev" style="border: none; background: #667eea; color: white; transition: all 0.3s ease;">
                                                <i class="fa fa-chevron-left"></i> Previous
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    @foreach ($kegiatan->getUrlRange(1, $kegiatan->lastPage()) as $page => $url)
                                        @if ($page == $kegiatan->currentPage())
                                            <li class="page-item active">
                                                <span class="page-link" style="border: none; background: #764ba2; color: white;">{{ $page }}</span>
                                            </li>
                                        @else
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $url }}" style="border: none; background: white; color: #667eea; transition: all 0.3s ease;">{{ $page }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                    ...
                                    @if ($kegiatan->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $kegiatan->nextPageUrl() }}" rel="next" style="border: none; background: #667eea; color: white; transition: all 0.3s ease;">
