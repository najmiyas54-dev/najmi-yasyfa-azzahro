...
@section('content')
<!-- Pengumuman Header -->
<section class="py-5" style="background: linear-gradient(135deg, #b8cdf5 0%, #d1d4f4 100%); margin-top: 70px;">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center text-white">
                <div class="mb-4">
                    <i class="fa fa-bullhorn fa-3x mb-3" style="opacity: 0.8;"></i>
                </div>
                <h1 class="mb-3" style="font-family: 'Baloo 2', cursive; font-weight: 700; font-size: 2.5rem;">Pengumuman Sekolah</h1>
                <p class="mb-4 lead">Informasi penting dan pengumuman terbaru dari SMK Bakti Nusantara 666</p>
                <div class="d-flex justify-content-center flex-wrap">
                    <span class="badge badge-light badge-pill px-3 py-2 mr-3 mb-2" style="font-size: 0.9rem;">
                        <i class="fa fa-bullhorn mr-1"></i> {{ \App\Models\Post::where('category', 'pengumuman')->where('status', 'approved')->count() }} Pengumuman
                    </span>
                    <span class="badge badge-light badge-pill px-3 py-2 mb-2" style="font-size: 0.9rem;">
                        <i class="fa fa-eye mr-1"></i> {{ number_format(\App\Models\Post::where('category', 'pengumuman')->sum('views_count')) }} Views
                    </span>
                </div>
            </div>
        </div>
...
<!-- Pengumuman Section -->
<section class="pengumuman-page py-5" style="background: #f8f9fa;">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h2 class="mb-1" style="color: #2c3e50; font-weight: 600;">Pengumuman Terbaru</h2>
                        <p class="text-muted mb-0">Informasi penting yang perlu diketahui seluruh warga sekolah</p>
                    </div>
                </div>
                        ...
                        @if($post->image_path && $post->image_path != '')
                            <div class="position-relative" style="overflow: hidden;">
                                ...
                                <div class="position-absolute" style="top: 15px; left: 15px;">
                                    <span class="badge badge-danger px-3 py-2" style="font-size: 0.8rem; border-radius: 20px;">
                                        <i class="fa fa-bullhorn mr-1"></i> Pengumuman
                                    </span>
                                </div>
                            </div>
                        @endif
                ...
                @else
                    <div class="text-center py-5">
                        <div class="mb-4">
                            <i class="fa fa-bullhorn fa-5x text-muted" style="opacity: 0.3;"></i>
                        </div>
                        <h4 class="text-muted mb-3">Belum Ada Pengumuman</h4>
                        <p class="text-muted mb-4">Pengumuman penting akan segera hadir. Pantau terus halaman ini untuk update terbaru!</p>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sticky-top" style="top: 100px;">
                    ...
                    <div class="card mb-4 shadow-sm" style="border: none; border-radius: 15px; overflow: hidden;">
                        <div class="card-header text-white" style="background: linear-gradient(135deg, #b8cdf5 0%, #d1d4f4 100%); border: none;">
                            <h5 class="mb-0 d-flex align-items-center">
                                <i class="fa fa-info-circle mr-2"></i> Tentang Pengumuman
                            </h5>
                        </div>
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted mb-0" style="font-size: 0.9rem; line-height: 1.5;">Media informasi resmi untuk menyampaikan pengumuman penting kepada seluruh warga SMK Bakti Nusantara 666.</p>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="text-muted d-flex align-items-center">
                                ...
                                <span>Menampilkan {{ $pengumuman->firstItem() }} - {{ $pengumuman->lastItem() }} dari {{ $pengumuman->total() }} pengumuman</span>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            <nav aria-label="Pengumuman pagination">
                                <ul class="pagination pagination-lg mb-0" style="border-radius: 10px; overflow: hidden;">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $pengumuman->previousPageUrl() }}" rel="prev" style="border: none; background: #dc3545; color: white; transition: all 0.3s ease;">
                                                <i class="fa fa-chevron-left"></i> Previous
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    @foreach ($pengumuman->getUrlRange(1, $pengumuman->lastPage()) as $page => $url)
                                        @if ($page == $pengumuman->currentPage())
                                            <li class="page-item active">
                                                <span class="page-link" style="border: none; background: #fd7e14; color: white;">{{ $page }}</span>
                                            </li>
                                        @else
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $url }}" style="border: none; background: white; color: #dc3545; transition: all 0.3s ease;">{{ $page }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                    ...
                                    @if ($pengumuman->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $pengumuman->nextPageUrl() }}" rel="next" style="border: none; background: #dc3545; color: white; transition: all 0.3s ease;">
